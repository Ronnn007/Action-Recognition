...
from pytorch_lightning.callbacks import PyTorchLightningPrBar
...
def main():
    ...
    video_dataset = LabeledVideoDataModule(train_paths=LabeledVideoPaths(train_paths), 
    ...
    model = ClassificationModel(num_classes=num_classes,lr=lr, wd=wd)
    ...
    # Trainer
    trainer = pl.Trainer(callbacks=[accuracy_log, earlystopping, PyTorchLightningPrBar],
                         max_epochs=10, accelerator='gpu',devices='auto',precision='16-mixed')
